...
final class Float256Vector extends FloatVector<Shapes.S256Bit> {
    ...
    @ForceInline
    @Override
    public Float256Vector neg(Mask<Float, Shapes.S256Bit> m) {
        return blend(neg(), m);
    }
    ...
    @ForceInline
    @Override
    public Float256Vector abs(Mask<Float, Shapes.S256Bit> m) {
        return blend(abs(), m);
    }
    ...
    @Override
    @ForceInline
    public Float256Vector min(Vector<Float,Shapes.S256Bit> v, Mask<Float, Shapes.S256Bit> m) {
    ...
    @Override
    @ForceInline
    public Float256Vector max(Vector<Float,Shapes.S256Bit> v, Mask<Float, Shapes.S256Bit> m) {
    ...
    @Override
    @ForceInline
    public Shuffle<Float, Shapes.S256Bit> toShuffle() {
        float[] a = toArray();
    ...
    @Override
    @ForceInline
    public final void intoArray(float[] a, int ax, Mask<Float, Shapes.S256Bit> m) {
    ...
    @Override
    @ForceInline
    public final void intoByteArray(byte[] a, int ix, Mask<Float, Shapes.S256Bit> m) {
    ...
    @Override
    @ForceInline
    public Float256Vector rearrange(Vector<Float, Shapes.S256Bit> v,
                                  Shuffle<Float, Shapes.S256Bit> s, Mask<Float, Shapes.S256Bit> m) {
    ...
    static final class Float256Shuffle extends AbstractShuffle<Float, Shapes.S256Bit> {
        ...
        @Override
        public Float256Shuffle rearrange(Vector.Shuffle<Float, Shapes.S256Bit> o) {
    ...
    static final class Float256Species extends FloatSpecies<Shapes.S256Bit> {
        ...
        public <F, T extends Shape> Float256Vector cast(Vector<F, T> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Float256Vector castDefault(Vector<F, T> v) {
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float256Mask cast(Mask<E, S> m) {
            if (m.length() != LENGTH)
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float256Shuffle cast(Shuffle<E, S> s) {
            if (s.length() != LENGTH)

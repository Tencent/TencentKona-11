...
final class Short512Vector extends ShortVector<Shapes.S512Bit> {
    ...
    @Override
    @ForceInline
    public Short512Vector min(Vector<Short,Shapes.S512Bit> v, Mask<Short, Shapes.S512Bit> m) {
    ...
    @Override
    @ForceInline
    public Short512Vector max(Vector<Short,Shapes.S512Bit> v, Mask<Short, Shapes.S512Bit> m) {
   ...
   public Short512Vector aShiftR(int s) {
    ...
    @Override
    @ForceInline
    public Short512Vector rearrange(Shuffle<Short, Shapes.S512Bit> o1) {
    ...
    static final class Short512Species extends ShortSpecies<Shapes.S512Bit> {
        ...
        public <F, T extends Shape> Short512Vector cast(Vector<F, T> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Short512Vector castDefault(Vector<F, T> v) {

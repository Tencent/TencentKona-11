...
final class Float128Vector extends FloatVector<Shapes.S128Bit> {
    ...
    @ForceInline
    @Override
    public Float128Vector neg(Mask<Float, Shapes.S128Bit> m) {
        return blend(neg(), m);
    }
    ...
    @ForceInline
    @Override
    public Float128Vector abs(Mask<Float, Shapes.S128Bit> m) {
        return blend(abs(), m);
    }
    ...
    @Override
    @ForceInline
    public Float128Vector pow(Vector<Float,Shapes.S128Bit> o) {
        Objects.requireNonNull(o);
        Float128Vector v = (Float128Vector)o;
    ...
    @Override
    @ForceInline
    public Float128Vector hypot(Vector<Float,Shapes.S128Bit> o) {
        Objects.requireNonNull(o);
        Float128Vector v = (Float128Vector)o;
        return (Float128Vector) VectorIntrinsics.binaryOp(
    ...
    @Override
    @ForceInline
    public Float128Vector atan2(Vector<Float,Shapes.S128Bit> o) {
        Objects.requireNonNull(o);
        Float128Vector v = (Float128Vector)o;
        return (Float128Vector) VectorIntrinsics.binaryOp(
    ...
    @Override
    @ForceInline
    public Shuffle<Float, Shapes.S128Bit> toShuffle() {
        float[] a = toArray();
    ...
    @Override
    @ForceInline
    public Float128Vector rearrange(Vector<Float, Shapes.S128Bit> v,
                                  Shuffle<Float, Shapes.S128Bit> s, Mask<Float, Shapes.S128Bit> m) {
        return this.rearrange(s).blend(v.rearrange(s), m);
    }

    @Override
    @ForceInline
    public Float128Vector rearrange(Shuffle<Float, Shapes.S128Bit> o1) {
    Objects.requireNonNull(o1);
    ...
    static final class Float128Shuffle extends AbstractShuffle<Float, Shapes.S128Bit> {
        ...
        @Override
        public Float128Shuffle rearrange(Vector.Shuffle<Float, Shapes.S128Bit> o) {
    ...
    static final class Float128Species extends FloatSpecies<Shapes.S128Bit> {
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Float128Vector castDefault(Vector<F, T> v) {
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float128Mask cast(Mask<E, S> m) {
            if (m.length() != LENGTH)
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float128Shuffle cast(Shuffle<E, S> s) {
            if (s.length() != LENGTH)

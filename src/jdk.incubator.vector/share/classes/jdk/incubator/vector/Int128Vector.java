...
final class Int128Vector extends IntVector<Shapes.S128Bit> {
    ...
    @Override
    @ForceInline
    public void intoByteArray(byte[] a, int ix, Mask<Integer, Shapes.S128Bit> m) {
    ...
    @Override
    @ForceInline
    public void intoByteBuffer(ByteBuffer bb, Mask<Integer, Shapes.S128Bit> m) {
        int idx = bb.position();
        Int128Vector oldVal = SPECIES.fromByteBuffer(bb, idx);
        Int128Vector newVal = oldVal.blend(this, m);
    ...
    static final class Int128Species extends IntSpecies<Shapes.S128Bit> {
        ...
        @Override
        @ForceInline
        public Int128Vector fromByteBuffer(ByteBuffer bb) {
            if (bb.hasArray() && !bb.isReadOnly() && bb.order() == ByteOrder.nativeOrder()) {
                int num_bytes = bitSize() / Byte.SIZE;
                int ix = VectorIntrinsics.checkIndex(bb.position(), bb.limit(), num_bytes);
                return (Int128Vector) VectorIntrinsics.load(Int128Vector.class, int.class, LENGTH,
                ...
                return (Int128Vector)super.fromByteBuffer(bb);
            }
        }

        @Override
        @ForceInline
        public Int128Vector fromByteBuffer(ByteBuffer bb, Mask<Integer, Shapes.S128Bit> m) {
        ...
        public Int128Vector fromByteBuffer(ByteBuffer bb, int ix) {
            if (bb.hasArray() && !bb.isReadOnly() && bb.order() == ByteOrder.nativeOrder()) {
                ...
                return (Int128Vector)super.fromByteBuffer(bb, ix);
            }
        }

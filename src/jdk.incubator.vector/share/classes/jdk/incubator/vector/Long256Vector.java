...
final class Long256Vector extends LongVector<Shapes.S256Bit> {
    ...
    public Long256Vector abs() {
        return (Long256Vector) VectorIntrinsics.unaryOp(
            ...
            this,
            v1 -> ((Long256Vector)v1).uOp((i, a) -> (long) Math.abs(a)));
    }
    ...
    @Override
    @ForceInline
    public void intoByteArray(byte[] a, int ix, Mask<Long, Shapes.S256Bit> m) {
    ...
    @Override
    @ForceInline
    public void intoByteBuffer(ByteBuffer bb, Mask<Long, Shapes.S256Bit> m) {
        int idx = bb.position();
        Long256Vector oldVal = SPECIES.fromByteBuffer(bb, idx);
        Long256Vector newVal = oldVal.blend(this, m);
    ...
    static final class Long256Species extends LongSpecies<Shapes.S256Bit> {
        ...
        @Override
        @ForceInline
        public Long256Vector fromByteBuffer(ByteBuffer bb) {
            if (bb.hasArray() && !bb.isReadOnly() && bb.order() == ByteOrder.nativeOrder()) {
                int num_bytes = bitSize() / Byte.SIZE;
                int ix = VectorIntrinsics.checkIndex(bb.position(), bb.limit(), num_bytes);
                return (Long256Vector) VectorIntrinsics.load(Long256Vector.class, long.class, LENGTH,
                ...
                return (Long256Vector)super.fromByteBuffer(bb);
            }
        }

        @Override
        @ForceInline
        public Long256Vector fromByteBuffer(ByteBuffer bb, Mask<Long, Shapes.S256Bit> m) {
        ...
        public Long256Vector fromByteBuffer(ByteBuffer bb, int ix) {
            if (bb.hasArray() && !bb.isReadOnly() && bb.order() == ByteOrder.nativeOrder()) {
                ...
                return (Long256Vector)super.fromByteBuffer(bb, ix);
            }
        }
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromByte(ByteVector<S> o) {
            if (o.bitSize() == 64) {
                Byte64Vector so = (Byte64Vector)o;
                return VectorIntrinsics.cast(
                    Byte64Vector.class, byte.class, so.length(),
                    long.class, LENGTH, so,
                    (v, t) -> (Long256Vector)super.cast(v)
                );
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromShort(ShortVector<S> o) {
            if (o.bitSize() == 64) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromInt(IntVector<S> o) {
            if (o.bitSize() == 64) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromLong(LongVector<S> o) {
            if (o.bitSize() == 64) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromFloat(FloatVector<S> o) {
            if (o.bitSize() == 64) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        private <S extends Shape> Long256Vector castFromDouble(DoubleVector<S> o) {
            if (o.bitSize() == 64) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        public <E, S extends Shape> Long256Vector cast(Vector<E, S> o) {
            Objects.requireNonNull(o);

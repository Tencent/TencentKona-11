...
final class Int64Vector extends IntVector<Shapes.S64Bit> {
    ...
    @ForceInline
    @Override
    public Int64Vector neg(Mask<Integer, Shapes.S64Bit> m) {
        return blend(neg(), m);
    }
    ...
    @ForceInline
    @Override
    public Int64Vector abs(Mask<Integer, Shapes.S64Bit> m) {
        return blend(abs(), m);
    }
    ...
    @ForceInline
    @Override
    public Int64Vector not(Mask<Integer, Shapes.S64Bit> m) {
        return blend(not(), m);
    }
    // Binary operations
    ...
    @Override
    @ForceInline
    public Int64Vector min(Vector<Integer,Shapes.S64Bit> v, Mask<Integer, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Int64Vector max(Vector<Integer,Shapes.S64Bit> v, Mask<Integer, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public int andAll(Mask<Integer, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public int orAll(Mask<Integer, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public int xorAll(Mask<Integer, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public int addAll(Mask<Integer, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((int) 0), m).addAll();
    }

    @Override
    @ForceInline
    public int subAll(Mask<Integer, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((int) 0), m).subAll();
    }

    @Override
    @ForceInline
    public int mulAll(Mask<Integer, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((int) 1), m).mulAll();
    }

    @Override
    @ForceInline
    public int minAll(Mask<Integer, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast(Integer.MAX_VALUE), m).minAll();
    }

    @Override
    @ForceInline
    public int maxAll(Mask<Integer, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast(Integer.MIN_VALUE), m).maxAll();
    }

    @Override
    @ForceInline
    public Shuffle<Integer, Shapes.S64Bit> toShuffle() {
        int[] a = toArray();
    ...
    @Override
    @ForceInline
    public Int64Vector rearrange(Vector<Integer, Shapes.S64Bit> v,
                                  Shuffle<Integer, Shapes.S64Bit> s, Mask<Integer, Shapes.S64Bit> m) {
        return this.rearrange(s).blend(v.rearrange(s), m);
    }

    @Override
    @ForceInline
    public Int64Vector rearrange(Shuffle<Integer, Shapes.S64Bit> o1) {
    ...
    static final class Int64Shuffle extends AbstractShuffle<Integer, Shapes.S64Bit> {
        ...
        @Override
        public Int64Shuffle rearrange(Vector.Shuffle<Integer, Shapes.S64Bit> o) {
    ...
    static final class Int64Species extends IntSpecies<Shapes.S64Bit> {
        ...
        public <F, T extends Shape> Int64Vector cast(Vector<F, T> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Int64Vector castDefault(Vector<F, T> v) {
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Int64Mask cast(Mask<E, S> m) {
            if (m.length() != LENGTH)
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Int64Shuffle cast(Shuffle<E, S> s) {
            if (s.length() != LENGTH)

...
final class Double128Vector extends DoubleVector<Shapes.S128Bit> {
    ...
    @Override
    @ForceInline
    public Double128Vector min(Vector<Double,Shapes.S128Bit> v, Mask<Double, Shapes.S128Bit> m) {
    ...
    @Override
    @ForceInline
    public Double128Vector max(Vector<Double,Shapes.S128Bit> v, Mask<Double, Shapes.S128Bit> m) {

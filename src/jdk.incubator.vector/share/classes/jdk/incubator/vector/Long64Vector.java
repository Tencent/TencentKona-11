...
final class Long64Vector extends LongVector<Shapes.S64Bit> {
    ...
    @Override
    @ForceInline
    public Long64Vector min(Vector<Long,Shapes.S64Bit> v, Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Long64Vector max(Vector<Long,Shapes.S64Bit> v, Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public long andAll(Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public long orAll(Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public long xorAll(Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public long addAll(Mask<Long, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((long) 0), m).addAll();
    }

    @Override
    @ForceInline
    public long subAll(Mask<Long, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((long) 0), m).subAll();
    }

    @Override
    @ForceInline
    public long mulAll(Mask<Long, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast((long) 1), m).mulAll();
    }

    @Override
    @ForceInline
    public long minAll(Mask<Long, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast(Long.MAX_VALUE), m).minAll();
    }

    @Override
    @ForceInline
    public long maxAll(Mask<Long, Shapes.S64Bit> m) {
        return blend(SPECIES.broadcast(Long.MIN_VALUE), m).maxAll();
    }

    @Override
    @ForceInline
    public Shuffle<Long, Shapes.S64Bit> toShuffle() {
        long[] a = toArray();
    ...
    @Override
    @ForceInline
    public final void intoArray(long[] a, int ax, Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public final void intoByteArray(byte[] a, int ix, Mask<Long, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Long64Vector rearrange(Vector<Long, Shapes.S64Bit> v,
                                  Shuffle<Long, Shapes.S64Bit> s, Mask<Long, Shapes.S64Bit> m) {
    ...
    static final class Long64Shuffle extends AbstractShuffle<Long, Shapes.S64Bit> {
        ...
        @Override
        public Long64Shuffle rearrange(Vector.Shuffle<Long, Shapes.S64Bit> o) {
    ...
    static final class Long64Species extends LongSpecies<Shapes.S64Bit> {
        ...
        public <F, T extends Shape> Long64Vector cast(Vector<F, T> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Long64Vector castDefault(Vector<F, T> v) {
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Long64Mask cast(Mask<E, S> m) {
            if (m.length() != LENGTH)
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Long64Shuffle cast(Shuffle<E, S> s) {
            if (s.length() != LENGTH)

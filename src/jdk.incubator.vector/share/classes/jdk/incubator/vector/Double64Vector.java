...
final class Double64Vector extends DoubleVector<Shapes.S64Bit> {
    ...
    @Override
    @ForceInline
    public Double64Vector min(Vector<Double,Shapes.S64Bit> v, Mask<Double, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Double64Vector max(Vector<Double,Shapes.S64Bit> v, Mask<Double, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Double64Vector rearrange(Shuffle<Double, Shapes.S64Bit> o1) {
    Objects.requireNonNull(o1);

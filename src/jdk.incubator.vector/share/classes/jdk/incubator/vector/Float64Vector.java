...
final class Float64Vector extends FloatVector<Shapes.S64Bit> {
    ...
    @ForceInline
    @Override
    public Float64Vector neg(Mask<Float, Shapes.S64Bit> m) {
        return blend(neg(), m);
    }
    ...
    @ForceInline
    @Override
    public Float64Vector abs(Mask<Float, Shapes.S64Bit> m) {
        return blend(abs(), m);
    }
    ...
    @Override
    @ForceInline
    public Float64Vector min(Vector<Float,Shapes.S64Bit> v, Mask<Float, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Float64Vector max(Vector<Float,Shapes.S64Bit> v, Mask<Float, Shapes.S64Bit> m) {
    ...
    @Override
    @ForceInline
    public Shuffle<Float, Shapes.S64Bit> toShuffle() {
        float[] a = toArray();
    ...
    @Override
    @ForceInline
    public Float64Vector rearrange(Vector<Float, Shapes.S64Bit> v,
                                  Shuffle<Float, Shapes.S64Bit> s, Mask<Float, Shapes.S64Bit> m) {
    ...
    static final class Float64Shuffle extends AbstractShuffle<Float, Shapes.S64Bit> {
        ...
        @Override
        public Float64Shuffle rearrange(Vector.Shuffle<Float, Shapes.S64Bit> o) {
    ...
    static final class Float64Species extends FloatSpecies<Shapes.S64Bit> {
        ...
        public <F, T extends Shape> Float64Vector cast(Vector<F, T> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F, T extends Shape> Float64Vector castDefault(Vector<F, T> v) {
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float64Mask cast(Mask<E, S> m) {
            if (m.length() != LENGTH)
        ...
        @Override
        @ForceInline
        public <E, S extends Shape> Float64Shuffle cast(Shuffle<E, S> s) {
            if (s.length() != LENGTH)

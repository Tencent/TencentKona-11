...
public class Continuation {
    ...
    private static final boolean TRACE = jdk.internal.misc.VM.getSavedProperty("java.lang.Continuation.trace") != null;
    private static final boolean DEBUG = TRACE | jdk.internal.misc.VM.getSavedProperty("java.lang.Continuation.debug") != null;
    ...
    /**
     * @param scope Continuation with specified scope
     * @return continuation on current thread with give scope
     */
    ...
    private boolean compareAndSetMounted(int expectedValue, int newValue) {
       boolean res = unsafe.compareAndSetInt(this, mountedOffset, expectedValue, newValue);
       return res;
     }

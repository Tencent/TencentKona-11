...
public class Byte64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<byte[]> fr = (vl) -> {
    ...
    static void andAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::andAll, Byte64VectorTests::andAll);
    }
    ...
    static void orAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::orAll, Byte64VectorTests::orAll);
    }
    ...
    static void xorAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::xorAll, Byte64VectorTests::xorAll);
    }
    ...
    static void mulAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::mulAll, Byte64VectorTests::mulAll);
    }
    ...
    static void minAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::minAll, Byte64VectorTests::minAll);
    }
    ...
    static void maxAllByte64VectorTests(IntFunction<byte[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::maxAll, Byte64VectorTests::maxAll);
    }

...
public class Double128VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<double[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void gatherDouble128VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length()); 
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void scatterDouble128VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length()); 
        double[] bb = fb.apply(SPECIES.length());
        int[] b = new int[bb.length];
        for (int i = 0; i < bb.length; i++) {

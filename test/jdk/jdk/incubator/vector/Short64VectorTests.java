 ...
 * @run testng/othervm -ea -esa Short64VectorTests
 */
...
public class Short64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<short[]> fr = (vl) -> {
    ...
    static void andAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::andAll, Short64VectorTests::andAll);
    }
    ...
    static void orAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::orAll, Short64VectorTests::orAll);
    }
    ...
    static void xorAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::xorAll, Short64VectorTests::xorAll);
    }
    ...
    static void mulAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::mulAll, Short64VectorTests::mulAll);
    }
    ...
    static void minAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::minAll, Short64VectorTests::minAll);
    }
    ...
    static void maxAllShort64VectorTests(IntFunction<short[]> fa) {
        ...
        assertReductionArraysEquals(a, r, ra, Short64VectorTests::maxAll, Short64VectorTests::maxAll);
    }

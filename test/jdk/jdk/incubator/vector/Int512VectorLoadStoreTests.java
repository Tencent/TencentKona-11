...
public class Int512VectorLoadStoreTests extends AbstractVectorTest {
    static final IntVector.IntSpecies<Shapes.S512Bit> SPECIES =
    ...
    static void loadStoreMaskArray(IntFunction<int[]> fa,
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < a.length; i += SPECIES.length()) {
                IntVector<Shapes.S512Bit> av = SPECIES.fromArray(a, i, vmask);
                av.intoArray(r, i);
            }
        }
    ...
    @Test(dataProvider = "intIndexMapProvider")
    static void loadStoreIndexMapArray(IntFunction<int[]> fa,
                                       IntFunction<int[]> fim) {
        int[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < a.length; i += SPECIES.length()) {
                IntVector<Shapes.S512Bit> av = SPECIES.fromArray(a, 0, im, i);
                av.intoArray(r, i);
            }
        }
...
*/
    ...
    @Test(dataProvider = "intIndexMapMaskProvider")
    static void loadStoreIndexMapMaskArray(IntFunction<int[]> fa,
                                           IntFunction<int[]> fim,
                                           IntFunction<boolean[]> fm) {
        int[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < a.length; i += SPECIES.length()) {
                IntVector<Shapes.S512Bit> av = SPECIES.fromArray(a, 0, vmask, im, i);
                av.intoArray(r, i);
            }
        }
...
*/
    ...
    static void loadStoreByteBuffer(IntFunction<int[]> fa,
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < l; i += s) {
                IntVector<Shapes.S512Bit> av = SPECIES.fromByteBuffer(a, i);
    ...
    static void loadStoreByteBufferMask(IntFunction<int[]> fa,
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < l; i += s) {
                IntVector<Shapes.S512Bit> av = SPECIES.fromByteBuffer(a, i, vmask);
                av.intoByteBuffer(r, i);
            }
        }
        Assert.assertEquals(a.position(), 0, "Input buffer position changed");

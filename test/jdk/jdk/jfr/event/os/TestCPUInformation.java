...
public class TestCPUInformation {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        for (RecordedEvent event : events) {
            ...
            Events.assertField(event, "cpu").containsAny("Intel", "AMD", "Unknown x86", "sparc", "ARM", "PPC", "PowerPC", "AArch64", "s390", "LoongArch");
            Events.assertField(event, "description").containsAny("Intel", "AMD", "Unknown x86", "SPARC", "ARM", "PPC", "PowerPC", "AArch64", "s390", "LoongArch");
        }
    }
}
